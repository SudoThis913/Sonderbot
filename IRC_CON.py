...
class IRCCON:
    ...
    def connect(self, **botconfig):
        ...
        self.port = str(botconfig['PORT'])
        self.botnick = botconfig['BOTNICK']
        self.botnick2 = botconfig['BOTNICK2']
        self.botnick3 = botconfig['BOTNICK3']
        self.botpass = botconfig['BOTPASS']
        self.botnickpass = botconfig['BOTNICKPASS']
        ...
        try:
            ...
            while timesAttempted > -1:
                ...
                try:
                    ...
                    self.connect(self,self.port,self.botnick,self.botnick2,self.botnick3,self.botpass,self.botnickpass)
                except ValueError:
                    continue
                except Exception:
                    traceback.print_exc()
